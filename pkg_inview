  ...
  begin
    ...
    if upper(p_process_name) = 'MANUAL' or
      ...
      for i in (select date_id
        ...
        load_inview_ad_cumulative(l_run_id, l_process_date, l_process_name);
    ...
    ---inview to date ad impressions
    load_inview_ad_to_date(l_run_id, l_process_date, l_process_name);
